addLayer("p", {
    ...
    resource: "prestige fragments", // Name of prestige currency
    ...
    hotkeys: [
        {key: "p", description: "P: Reset for prestige fragments", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
